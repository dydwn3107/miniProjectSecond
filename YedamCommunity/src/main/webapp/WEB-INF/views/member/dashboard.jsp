                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="chart-legend">
                                        <i class="fa fa-circle text-info"></i> 스터디/프로젝트 모집
                                        <i class="fa fa-circle text-danger"></i> 질문게시판
                                        <i class="fa fa-circle text-warning"></i> 자유게시판
                                    </div>
                                    <hr>
                                    <div class="stats">
                        ...
                        <div class="card ">
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="chart-legend">
                                        <i class="fa fa-circle text-info"></i> number of users
                                        <i class="fa fa-circle text-warning"></i> number of subscribers
                                    </div>
                                    <hr>
                                    <div class="stats">
