...
<body>
	...
	<!-- 스터디카페글 등록 실패 시. 돌아왔을때 실패메세지 alert -->
	<c:if test="${not empty cafeInfoInsertMessage}">
		<div class="alert alert-primary" role="alert">${cafeInfoInsertMessage}</div>
	</c:if>

	<div class="register">
		<form action="cafeInfoInsert.do" onsubmit="return hashtagCombine()" method="post" enctype="multipart/form-data">
			<div class="row">
			                ...
			                <div class="row register-form">
			                    ...
			                    <div class="col-md-6">
			                        <div class="form-group">
			                            <input type="text" class="form-control" placeholder="스터디 카페 이름" value=""
			                            	id="cafeInfoName" name="cafeInfoName" required />
			                        </div>
			                    </div>
			                    <div class="col-md-6">
			                        <div class="form-group">
			                            <input type="text" class="form-control" placeholder="스터디 카페 링크" value=""
			                    ...
			                    <div class="col-md-6">
			                        <div class="form-group">
			                            <input type="file" class="form-control" value="" id="cafeInfoAttech" name="cafeInfoAttech" required />
			                        </div>
			                    </div>
			                    ...
			                    <div class="col-md-5">
			                        ...
			                        <input type="submit" class="btnRegister"  value="카페 등록"/>
