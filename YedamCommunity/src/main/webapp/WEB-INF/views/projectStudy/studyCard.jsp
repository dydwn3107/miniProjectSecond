			...
			<div id="categorys" style="margin-left: 30px;" onclick="location.href='studyCard.do'">
				<h3 class="display-6">
					<span style="opacity: 1;">
						<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16" opacity="1" style="margin-right:5px; margin-bottom: 10px;">
